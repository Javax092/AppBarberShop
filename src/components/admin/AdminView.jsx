...
export function AdminView(props) {
  ...
  return (
    <section className={cx.layout}>
      ...
      <BrandManager brandConfig={props.brandConfig} onBrandConfigChange={props.onBrandConfigChange} onSaveBrandSettings={props.onSaveBrandSettings} isSavingBrand={props.isSavingBrand} onUploadBrandLogo={props.onUploadBrandLogo} staffFeedback={props.staffFeedback} session={props.session} />
      <div className={cx.twoCol}>
