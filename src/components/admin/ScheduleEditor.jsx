            ...
            {editorForm ? (
              <>
                <div className="form-grid">
                  ...
                  <label>Status<select value={editorForm.status} onChange={(event) => onEditorChange("status", event.target.value)}><option value="pending">Pendente</option><option value="confirmed">Confirmado</option><option value="completed">Concluido</option><option value="cancelled">Cancelado</option></select></label>
